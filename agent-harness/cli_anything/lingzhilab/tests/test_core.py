"""
Unit tests for cli_anything.lingzhilab core modules.
...
Run with:
    ...
    pytest agent-harness/cli_anything/lingzhilab/tests/test_core.py -q
"""
...
class TestSessionFile(unittest.TestCase):
    ...
    def _patch_session_file(self):
        return patch("cli_anything.lingzhilab.core.session.SESSION_FILE", self.session_path)

    def _patch_legacy_session_file(self):
        return patch("cli_anything.lingzhilab.core.session.LEGACY_SESSION_FILE", self.session_path)

    def test_login_stores_token(self):
        """login() should write the JWT token to the session file."""
        from cli_anything.lingzhilab.core.session import LingzhiLab
    ...
    def test_get_token_prefers_env_var(self):
        """LINGZHILAB_TOKEN env var should take precedence over the session file."""
        from cli_anything.lingzhilab.core.session import LingzhiLab

        self.session_path.write_text(json.dumps({"token": "file-token"}))

        with self._patch_session_file(), self._patch_legacy_session_file():
            # Test LINGZHILAB_TOKEN (highest priority)
            with patch.dict(os.environ, {"LINGZHILAB_TOKEN": "env-token"}):
                client = LingzhiLab()
                token = client.get_token()
    ...
    def test_not_logged_in_error(self):
        ...
        from cli_anything.lingzhilab.core.session import NotLoggedInError, LingzhiLab
    ...
    def test_get_base_url_env_var(self):
        """LINGZHILAB_URL env var overrides the default."""
        from cli_anything.lingzhilab.core.session import LingzhiLab

        with self._patch_session_file(), self._patch_legacy_session_file():
            with patch.dict(os.environ, {"LINGZHILAB_URL": "http://myserver:4000"}):
                client = LingzhiLab()
                url = client.get_base_url()
    ...
    def test_get_base_url_override_param(self):
        ...
        with self._patch_session_file(), self._patch_legacy_session_file():
            with patch.dict(os.environ, {"LINGZHILAB_URL": "http://env:9000"}):
                client = LingzhiLab(url_override="http://explicit:1234")
                url = client.get_base_url()
...
class TestProjects(unittest.TestCase):
    ...
    def _make_client(self, json_data, status_code=200):
        """Return a mock LingzhiLab client whose HTTP methods return fake responses."""
        from cli_anything.lingzhilab.core.session import LingzhiLab

        client = MagicMock(spec=LingzhiLab)
    ...
    def test_list_projects_returns_list(self):
        ...
        from cli_anything.lingzhilab.core.projects import list_projects
    ...
    def test_rename_project_calls_put(self):
        ...
        from cli_anything.lingzhilab.core.projects import rename_project
    ...
    def test_add_project_manual_calls_create_endpoint(self):
        ...
        from cli_anything.lingzhilab.core.projects import add_project_manual
    ...
    def test_delete_project_calls_delete(self):
        ...
        from cli_anything.lingzhilab.core.projects import delete_project
    ...
    def test_create_project_workspace_calls_create_workspace_endpoint(self):
        ...
        from cli_anything.lingzhilab.core.projects import create_project_workspace
...
class TestDigests(unittest.TestCase):
    ...
    def test_build_portfolio_digest_recommends_waiting_project(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_portfolio_digest
    ...
    def test_get_project_latest_message_picks_latest_session(self):
        ...
        from cli_anything.lingzhilab.core.projects import get_project_latest_message
...
class TestConversations(unittest.TestCase):
    ...
    def test_list_sessions_returns_page(self):
        ...
        from cli_anything.lingzhilab.core.conversations import list_sessions
        from cli_anything.lingzhilab.core.session import LingzhiLab
    ...
    def test_get_session_messages_returns_messages(self):
        ...
        from cli_anything.lingzhilab.core.conversations import get_session_messages
        from cli_anything.lingzhilab.core.session import LingzhiLab
...
class TestTaskMaster(unittest.TestCase):
    ...
    def test_get_summary_hits_server_summary_endpoint(self):
        ...
        from cli_anything.lingzhilab.core.session import LingzhiLab
        from cli_anything.lingzhilab.core.taskmaster import get_summary
    ...
    def test_build_summary_falls_back_to_composed_calls(self):
        ...
        from cli_anything.lingzhilab.core.session import LingzhiLab
        from cli_anything.lingzhilab.core.taskmaster import build_summary
...
class TestChat(unittest.TestCase):
    ...
    def test_get_active_sessions_normalizes_provider_metadata(self):
        from cli_anything.lingzhilab.core.chat import get_active_sessions
        from cli_anything.lingzhilab.core.session import LingzhiLab
    ...
    def test_get_processing_sessions_maps_server_active_sessions(self):
        from cli_anything.lingzhilab.core.chat import get_processing_sessions
        from cli_anything.lingzhilab.core.session import LingzhiLab
        ...
        with patch("cli_anything.lingzhilab.core.chat.get_active_sessions", return_value=known_sessions), patch(
            "cli_anything.lingzhilab.core.chat._ws_request",
            return_value={
    ...
    def test_check_session_status_uses_websocket_request(self):
        from cli_anything.lingzhilab.core.chat import check_session_status
        from cli_anything.lingzhilab.core.session import LingzhiLab
    ...
    def test_get_waiting_sessions_compact_returns_stable_schema(self):
        from cli_anything.lingzhilab.core.chat import get_waiting_sessions_compact
        from cli_anything.lingzhilab.core.session import LingzhiLab

        client = MagicMock(spec=LingzhiLab)
        with patch(
            "cli_anything.lingzhilab.core.chat.get_processing_sessions",
            return_value=[
                {
                    "project_name": "proj-1",
                    "project_display_name": "Project One",
...
class TestCliHelpers(unittest.TestCase):
    ...
    def _make_context(self):
        from cli_anything.lingzhilab.lingzhilab_cli import Context
        from cli_anything.lingzhilab.core.session import LingzhiLab

        return Context(json_mode=True, client=MagicMock(spec=LingzhiLab), lang="en")

    def test_resolve_session_provider_finds_unique_provider(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _resolve_session_provider
        from cli_anything.lingzhilab.core.session import LingzhiLab
        ...
        with patch(
            "cli_anything.lingzhilab.lingzhilab_cli.chat_mod.get_active_sessions",
            return_value=[
    ...
    def test_maybe_send_openclaw_chat_notification_disabled(self):
        ...
        from cli_anything.lingzhilab.lingzhilab_cli import _maybe_send_openclaw_chat_notification
    ...
    def test_maybe_send_openclaw_chat_notification_sends_message(self):
        ...
        mock_ctx = MagicMock()
        with patch(
            "cli_anything.lingzhilab.lingzhilab_cli._resolve_push_channel",
            return_value="feishu:test",
        ), patch(
            "cli_anything.lingzhilab.lingzhilab_cli._send_openclaw_message",
            return_value="ok",
        ) as send_message:
            result = _maybe_send_openclaw_chat_notification(
                self._make_context(),
    ...
    def test_install_openclaw_skill_copies_skill_tree_and_updates_session(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _install_openclaw_skill
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            wrapper = scripts_dir / "openclaw_lingzhilab_turn.sh"
            wrapper.write_text("#!/bin/sh\nexit 0\n")
            waiter = scripts_dir / "lingzhilab_wait_until_clear.sh"
            waiter.write_text("#!/bin/sh\nexit 0\n")

            with patch("cli_anything.lingzhilab.lingzhilab_cli._OPENCLAW_SKILL_SOURCE_DIR", source_dir), patch(
                "cli_anything.lingzhilab.lingzhilab_cli.SESSION_FILE", session_file
            ), patch(
                "cli_anything.lingzhilab.core.session.SESSION_FILE", session_file
            ), patch(
                "cli_anything.lingzhilab.lingzhilab_cli._resolve_current_lingzhilab_bin",
                return_value="/tmp/bin/lingzhilab",
            ):
            ...
            installed_skill = openclaw_home / "workspace" / "skills" / "lingzhilab" / "SKILL.md"
            installed_wrapper = openclaw_home / "workspace" / "skills" / "lingzhilab" / "scripts" / "openclaw_lingzhilab_turn.sh"
            ...
            self.assertEqual(session_data["openclaw_lingzhilab_bin"], "/tmp/bin/lingzhilab")

    def test_build_artifact_brief_compacts_server_payload(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_artifact_brief
    ...
    def test_build_openclaw_turn_schema_marks_decision_needed(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_openclaw_turn_schema
    ...
    def test_build_openclaw_project_schema_marks_attention(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_openclaw_project_schema
    ...
    def test_build_openclaw_portfolio_schema_exposes_focus(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_openclaw_portfolio_schema
    ...
    def test_build_openclaw_event_schema_maps_permission_request(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_openclaw_event_schema
...
class TestOpenClawWatcherDaemon(unittest.TestCase):
    ...
    def test_should_notify_deduplicates_same_signature(self):
        from cli_anything.lingzhilab.core import openclaw_daemon as daemon_mod
    ...
    def test_build_project_digest_avoids_waiting_websocket_calls(self):
        ...
        with patch(
            "cli_anything.lingzhilab.core.openclaw_daemon.taskmaster_mod.build_summary",
            return_value={"status": "taskmaster-only", "counts": {"total": 1, "completed": 0}, "next_task": {}, "guidance": {}, "updated_at": "2026-03-21T22:00:00Z"},
        ), patch(
            "cli_anything.lingzhilab.core.openclaw_daemon.taskmaster_mod.get_artifact_summary",
            return_value={"artifacts": [], "latestArtifact": {}, "totalArtifacts": 0},
        ), patch(
            "cli_anything.lingzhilab.core.openclaw_daemon.chat_mod.get_waiting_sessions_compact",
    ...
    def test_build_daily_digest_aggregates_counts(self):
        from cli_anything.lingzhilab.lingzhilab_cli import _build_daily_digest
...
class TestOutput(unittest.TestCase):
    ...
    def test_output_json_mode_list(self):
        ...
        from cli_anything.lingzhilab.utils.output import output
    ...
    def test_success_json_mode(self):
        ...
        from cli_anything.lingzhilab.utils.output import success
    ...
    def test_error_goes_to_stderr(self):
        ...
        from cli_anything.lingzhilab.utils.output import error
    ...
    def test_info_goes_to_stderr(self):
        ...
        from cli_anything.lingzhilab.utils.output import info
