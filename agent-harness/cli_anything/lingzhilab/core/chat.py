"""WebSocket chat helpers for the LingzhiLab server."""
...
def send_message(
    ...
    """
    Connect to the LingzhiLab WebSocket, send a provider command, collect the full
            ...
            async def receive_loop() -> None:
                ...
                while True:
                    ...
                    if event_type == "session-created":
                        ...
                        err_msg = event.get("error", "Unknown error from LingzhiLab server")
                        raise RuntimeError(f"LingzhiLab server error: {err_msg}")
...
def get_active_sessions(client: LingzhiLab) -> List[Dict[str, Any]]:
    """
...
def get_processing_sessions(client: LingzhiLab) -> List[Dict[str, Any]]:
...
def get_waiting_sessions_compact(client: LingzhiLab) -> List[Dict[str, Any]]:
...
def check_session_status(client: LingzhiLab, session_id: str, provider: str = "claude") -> Dict[str, Any]:
