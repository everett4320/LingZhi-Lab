"""
Project-level operations against the LingzhiLab REST API.

All functions accept a `LingzhiLab` client instance as their first argument so
...
def list_projects(client: LingzhiLab) -> List[Dict[str, Any]]:
    """
    GET /api/projects
...
def rename_project(client: LingzhiLab, project_name: str, new_name: str) -> bool:
    """
...
def delete_project(client: LingzhiLab, project_id: str) -> bool:
    """
...
def create_project_workspace(
    ...
    LingzhiLab project. Returns the created project dict.
    """
    body: Dict[str, Any] = {
        "workspaceType": "new",
        "path": path,
